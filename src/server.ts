...
import { handler as menuHandler, getWeekHandler, clearWeekHandler, swapHandler, stepsHandler, adaptHandler, catalogHandler, foodScanHandler } from './generateMenu.js';
